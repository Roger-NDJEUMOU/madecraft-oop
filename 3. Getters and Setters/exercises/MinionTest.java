...
/**
 * To make these tests pass, you will need to create a Minion class
 ...
 * </code>
 *
 * Create a constructor, and getters and setters for the member variables.
 * If they’re done right, these tests will pass.
 *
 * **/
...
public class MinionTest {
	...
	public void testConstructor() {
		...
		Minion dave = new Minion("Dave", 2, "Green", "");
		assertEquals("Dave", dave.getName());
		assertEquals(2, dave.getEyes());
		assertEquals("Green", dave.getColor());
	}
